    ...
    <div class="container special-collection" style="margin-top: 150px;">
        <div class="row">
           ...
           ?>
                ...
                <div class="col-6">
                    <select class="form-control border" onchange="location.href = 'index.php?controller=products&action=category&catId=<?php echo $categoryId ?>&order='+this.value;">
        ...
        <div class="row">
            <div style="margin-top: 50px;"
                        ...
                        <ul class="pagination">
                            ...
                            <li class="page-item mx-2"><a class=" btn btn-outline-dark"
                                    href="index.php?controller=products&action=category&catId=<?php echo $categoryId; ?>&p=<?php echo $i; ?>">
                                    <?php echo $i; ?>
                                </a></li>
                            <?php endfor; ?>
                        </ul>
